                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="index.php?ac=dangxuat"><i class="fa fa-sign-out fa-fw"></i>Logout</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                        ...
                        <div class="col-lg-10">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                   <img src="https://vietmoz.edu.vn/wp-content/uploads/2019/09/Co%CC%82ng-cu%CC%A3-check-traffic-web-mi%CC%80nh.jpg" alt="">
                                </div>
            </div>
            </div>
        </div>
